...
log.info("query: Find top 3 Hotels that have been booked most times")
query_str = "SELECT Name, Type, in(\"HasStayed\").size() AS NumberOfBookings " \
            "FROM Hotels " \
            "ORDER BY NumberOfBookings DESC LIMIT 3"
