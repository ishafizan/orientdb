...
log.info("query: Find all Locations connected to Customer with OrderedId 1, and their Reviews (if any)")
query_str = "MATCH {class: Customers, as: c, where: (OrderedId=1)}" \
            "--{class: Locations, as: loc}" \
            "-HasReview->{class: Reviews, as: r, optional: true} " \
            "RETURN $pathelements"
